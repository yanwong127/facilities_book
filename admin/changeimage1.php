			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Item Image  </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Item Image Details</div>
...
<div class="col-sm-8">
<img src="img/image/<?php echo htmlentities($result->item_image);?>" width="300" height="200" style="border:solid 1px #000">
</div>
<?php }}?>
</div>
